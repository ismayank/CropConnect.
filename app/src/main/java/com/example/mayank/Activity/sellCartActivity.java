...
public class sellCartActivity extends BaseActivity {
        ...
        cbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(code.equals("MAYANK")){
                    discount=0.10;
                    calculatorCart(discount);
                    Toast.makeText(sellCartActivity.this,"Yayy! you got 10% off", Toast.LENGTH_LONG).show();
                }
                else if(code.equals("ANUSHKA")){
                    discount=0.25;
                    calculatorCart(discount);
                    Toast.makeText(sellCartActivity.this,"Yayy! you got 25% off", Toast.LENGTH_LONG).show();
                }
                else if(code.equals("MAD")){
                    discount=0.15;
                    calculatorCart(discount);
                    Toast.makeText(sellCartActivity.this,"Yayy! you got 15% off", Toast.LENGTH_LONG).show();
                }
                else {
                    discount=0.00;
                    calculatorCart(discount);
    ...
    public  void checkOut(View view){
        ...
        Toast.makeText(sellCartActivity.this,"Please Pay $"+totalin,Toast.LENGTH_LONG).show();
